...
import com.ajailani.grid_compose.util.VerticalGridScope
...
fun VerticalGrid(
    ...
    Layout(
        ...
        val columnCount: Int = when (columns) {
            is GridType.Fixed -> columns.count
            is GridType.Adaptive -> constraints.maxWidth / columns.minSize.roundToPx()
        }

        val totalRow = ceil(verticalGridScope.itemSize.toDouble() / columnCount.toDouble()).toInt()
